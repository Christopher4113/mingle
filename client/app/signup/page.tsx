...
import { Users, User, Mail, Lock, Eye, EyeOff, AlertCircle, CheckCircle } from "lucide-react"
...
const Page = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccess("Account created successfully! Welcome to Mingle!")
      setTimeout(() => {
        router.push("/login")
      }, 2000)
    } catch (error: unknown) {
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center justify-center mb-4">
            <div className="bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 rounded-full p-3 shadow-lg">
          ...
          <p className="text-gray-600">Connect, network, and discover amazing events</p>
        </div>
        ...
        <Card className="bg-white/80 backdrop-blur-sm border-gray-200 shadow-2xl">
          <CardHeader className="space-y-1 pb-6">
            ...
            <CardDescription className="text-center text-gray-600">
              Join the community and start networking with like-minded people
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <Button
                type="submit"
                className="w-full bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 hover:from-blue-600 hover:via-purple-600 hover:to-pink-600 text-white font-medium py-2.5 transition-all duration-200 shadow-lg hover:shadow-xl border-0"
                disabled={isLoading}
              >
                {isLoading ? (
            ...
            <div className="text-center">
              <p className="text-sm text-gray-600">
                ...
                <Link
                  href="/login"
                  className="font-medium bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent hover:underline transition-colors"
                >
                  Sign In
                </Link>
              </p>
